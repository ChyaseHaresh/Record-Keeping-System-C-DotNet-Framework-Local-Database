...
namespace browse
{
    public partial class yec : Form
    {
        ...
        public void loadData()
        {
            ...
            {
                string Q = "SELECT members.fname, members.age, members.address, members.email, members.phone, members.education, members.gender, members.mtype FROM members inner join assign on assign.id= members.id WHERE ccid=2";
        ...
        private void yec_Load(object sender, EventArgs e)
        {
            loadData();
        }
    }
